...
function getChunkPatchJs() {
  if (!chunkPatchJs) {
    ...
    chunkPatchJs =
      ...
      "if(/\\/textures\\/boot_screen_mobile\\.png/i.test(u))return'/pixela-boot-screen-mobile.png?v=168';" +
      "if(/\\/textures\\/boot_screen\\.png/i.test(u))return'/pixela-boot-screen.png?v=168';" +
