/** Site metinleri — İngilizce → Türkçe (shader.se proxy) */
const BRAND = 'PIXELA';
const WP_PHONE = '905319282677';
const WP_URL =
  'https://wa.me/' + WP_PHONE + '?text=' + encodeURIComponent('Merhaba, PIXELA web sitesinden yazıyorum.');
...
const BASE_PAIRS = [
  ...
  ['Send email to hello@shader.se', 'hello@shader.se adresine e-posta gönder'],
  ['Send email to ceo@shader.se', 'ceo@shader.se adresine e-posta gönder'],
  ...
  [
    ...
    '# Açık Kapı Politikamız\n\nSon teknoloji 3B canvas’ımız iş akışınızda darboğaz yaratıyorsa veya verimliliğinizi düşürüyorsa bunu bilmek isteriz. Sonuçta biz bürokrasi değil, sonuç üretme işindeyiz. Ekibinizin secretary@shader.se adresinden yönetici sekreterimize ulaşmasını rica ederiz. Hizmetlerimizin düz metin özetini gelen kutunuza iletmek, bir sonraki projenizi kapsamlandırmak veya yapay zekânın geleceği hakkında sohbet etmekten memnuniyet duyarız.\n',
  ],
  [
