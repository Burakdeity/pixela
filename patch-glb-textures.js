/** shredder.glb — splash-logo + beige-logo (klavye rozeti) → PIXELA */
const fs = require('fs');
...
/** Klavye rozeti — dikey logo harfleri tamamen sil (y≈242-682) */
...
async function main() {
  ...
  console.log('  splash-logo (splash):', splashTex.length, 'byte');
}
